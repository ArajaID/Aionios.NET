...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ config('app.name', 'Aionios.NET') }}</title>
    ...
    <body class="font-sans antialiased bg-stone-100 text-stone-900 min-h-screen selection:bg-stone-800 selection:text-white">
        @inertia
    </body>
</html>
